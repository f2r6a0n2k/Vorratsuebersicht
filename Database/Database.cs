    ...
    public static class Database
    {
        internal static void UpdateStorageItemQuantity(StorageItemQuantityResult storageItem)
        {
            ...
            if (storageItem.StorageItemId == 0)
            {
                ...
                // Neue Lagerposition-Id �bernehmen.
            ...
            else
            {
                if (storageItem.Quantity == 0)
                {
                    TRACE("Lagerposition L�schung: {0}, {1}, {2}", storageItem.StorageItemId, storageItem.BestBefore_DebuggerDisplay, storageItem.StorageName);
                ...
                {
                    TRACE("Lagerposition �nderung: {0}, {1}, {2}", storageItem.Quantity, storageItem.BestBefore_DebuggerDisplay, storageItem.StorageName);
        ...
        internal static void DeleteAllStorageItems()
        {
            ...
            TRACE("Alle Lagerpositionen l�schen");
        ...
        internal static void LogChange(SQLite.SQLiteConnection db, object entity, string operation)
        {
            try
            {
                ...
                {
                    // Bilder nicht synchronisieren (zu gro�)
                    return;
                }
                else
                {
